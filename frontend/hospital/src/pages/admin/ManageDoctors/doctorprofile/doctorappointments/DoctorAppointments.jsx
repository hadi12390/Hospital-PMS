...
import appStyles from "./DoctorAppointments.module.css";
...
import AppointmentsTable from "./table/AppointmentsTable.jsx";




function ManageDoctorsAppointments() {
  // ---------- Date helpers ----------
    ...
    <div className={styles.DoctorDashboard}>
      ...
      <section className={styles.dashboardContent}>
        ...
        <main className={styles.cards}>
            <div className={appStyles.heroName} >
                Dr.Jessica Appointments Detalis
            </div>
          ...
          <div className={layoutStyles.statsRow}>
            ...
            <div className={layoutStyles.statCard}>
              <p className={layoutStyles.statLabel}>Upcoming</p>
...
export default ManageDoctorsAppointments;